...
** El nombre contiene «'vol'»
** El nombre de SVM es «data_svm».
El grupo de condiciones 1 selecciona todos los volúmenes que incluyen «`vol`» en sus nombres y que están alojados en SVM con el nombre «daata_svm».
...
El grupo de condiciones 2 selecciona todos los volúmenes que incluyen «`vol`» en sus nombres y que se anotan con el valor de anotación de prioridad de datos como «`crítico ».
