...
Para obtener más información, consulte link:../data-protection/task_restore_data_use_health_volume_details_page.html["Restaurar datos mediante la página de detalles Volume / Health"].
...
*** Copias Snapshot sin configuración de retención
En una relación de SnapVault en cascada donde el origen es un volumen de protección de datos (DP), solo se aplica la regla «sm_created».
