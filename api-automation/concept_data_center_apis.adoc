...
Para ver la información de métricas y análisis de los objetos de almacenamiento, consulte link:concept_metrics_apis.html["Ver las métricas de rendimiento"].
