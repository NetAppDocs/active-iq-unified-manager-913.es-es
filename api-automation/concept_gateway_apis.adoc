...
----
Para obtener más información sobre el uso de las API de REST de ONTAP, consulte
https://docs.netapp.com/us-en/ontap-automation/index.html["Automatización de la API DE REST de ONTAP"]
