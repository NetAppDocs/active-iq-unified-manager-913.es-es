...
Advertencia
 ...
 a| 
La supervisión anti-ransomware de la máquina virtual de almacenamiento está deshabilitada
...
Advertencia
 ...
 a| 
La supervisión antiransomware de la máquina virtual de almacenamiento está habilitada (modo de aprendizaje)
