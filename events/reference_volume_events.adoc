...
| Nombre del evento (nombre de la captura) | Nivel de impacto | Tipo de origen | Gravedad 
 ...
 a| 
La supervisión contra ransomware del volumen está habilitada (modo activo)
...
Información
 ...
 a| 
La supervisión del volumen frente a ransomware está deshabilitada
...
Advertencia
 ...
 a| 
La supervisión contra ransomware del volumen está habilitada (modo de aprendizaje)
...
Información
 ...
 a| 
La supervisión del volumen frente a ransomware se está pausando (modo de aprendizaje)
...
Advertencia
 ...
 a| 
La supervisión de volúmenes frente a ransomware está en pausa (modo activo)
...
Advertencia
 ...
 a| 
La supervisión frente al ransomware del volumen está deshabilitando
...
Advertencia
 ...
 a| 
Actividad de ransomware vista
(Llamada HomeRansomwareActivitySeen)
 a| 
Incidente
 a| 
Volumen
