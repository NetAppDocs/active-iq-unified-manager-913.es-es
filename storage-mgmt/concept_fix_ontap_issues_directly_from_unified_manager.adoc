...
Para obtener más información sobre los problemas y funciones de ONTAP que puede gestionar mediante la solución automática, consulte link:../storage-mgmt/reference_what_ontap_issues_can_unified_manager_fix.html["¿Qué problemas puede solucionar Unified Manager"].
