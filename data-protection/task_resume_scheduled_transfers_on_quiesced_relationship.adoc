...
... En la página de detalles del trabajo, haga clic en *Actualizar* para actualizar la lista de tareas y los detalles de las tareas asociadas con el trabajo de configuración de protección y para determinar cuándo se ha completado el trabajo.
Cuando los trabajos finalizan, las transferencias de datos se reanudan en el siguiente intervalo de transferencia programado.
